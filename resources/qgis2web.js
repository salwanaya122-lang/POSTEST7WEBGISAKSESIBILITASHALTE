...
map.getView().fit([12549383.763195, -812306.569673, 12551663.635124, -808482.581696], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">WEBGIS AKSESIBILITAS HALTE KELURAHAN GENTENG</h2>';
        return titleElement;
    })(),
